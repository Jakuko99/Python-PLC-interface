        ...
        while not self.isInterruptionRequested():
            ...
            if data is not None:
                ...
                if data["Cesta"]["stavanie"]:
                    ...
                    ) and (data["Cesta"]["odosielatel"] != "RAD"):
...
class App(QMainWindow):  # hlavná triedy vizualizácie
    ...
    def akciaNavestidlo(
        ...
        if ((ID in [1, 2]) and index == 1) and (
            ...
            self.Start == self.dictNav[3].ID and ID in [10, 12] and index == 1
        ...
        elif (self.Start == self.dictNav[3].ID) and (
        ...
        elif (self.Start in [self.dictNav[4].ID, self.dictNav[5].ID]) and (
        ...
        elif (self.Start in [1] and ID == 10 and index == 3) or (
            ID == 11 and index == 1
        ):  # stavanie posunovej cesty
            self.postavCestu()

        elif ((ID == 1 and index == 2) or (ID == 2 and index == 3)) and (
            self.lastNav not in [9, 10]
        ):  # Privolávacia návesť
            ...
            if self.dictNav[
                self.lastNav
            ].pociatocne:  # iba ak je návestidlo počiatočným návestidlom jazdnej cesty
    ...
    def akciaTS(self, index):  # metóda pre prácu s traťovým súhlasom
        if index == 1:  # žiadosť o TS
            if (not self.workerThread.dictTS[1].prijem) and (
                not self.workerThread.dictTS[1].odchod
            ):
            ...
            self.workerThread.dictTS[1].ziadost is True
        ):  # udelenie TS
...
if __name__ == "__main__":
    ...
    widget.ui.combo_TS_ZBE.currentIndexChanged.connect(
        lambda: widget.akciaTS(widget.ui.combo_TS_ZBE.currentIndex())
    )  # traťový súhlas
