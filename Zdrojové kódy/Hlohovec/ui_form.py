...
class Ui_ILTIS(object):
    def setupUi(self, ILTIS):
        ...
        self.actionPriponiemka.setObjectName("actionPriponiemka")
        ...
        self.actionIdentifik_cei_u_vate_a.setObjectName("actionIdentifik_cei_u_vate_a")
        ...
        self.HLO_k1.setObjectName("HLO_k1")
        ...
        self.HLO_k2.setObjectName("HLO_k2")
        ...
        self.HLO_S1.setObjectName("HLO_S1")
        ...
        self.HLO_S2.setObjectName("HLO_S2")
        ...
        self.HLO_V1.setObjectName("HLO_V1")
        self.HLO_V1.setGeometry(QRect(1070, 310, 117, 125))
        icon3 = QIcon()
        icon3.addFile("img/Vyhybka/VyhLH_basic.bmp", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.HLO_fik_L.setObjectName("HLO_fik_L")
        self.HLO_fik_L.setGeometry(QRect(876, 322, 23, 43))
        icon4 = QIcon()
        icon4.addFile("img/Fiktivne/Fikt_basicL.bmp", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.HLO_zr_do_st_odZ.setObjectName("HLO_zr_do_st_odZ")
        self.HLO_zr_do_st_odZ.setGeometry(QRect(1047, 322, 23, 43))
        icon5 = QIcon()
        icon5.addFile("img/Zriad/Zriad_basicP.bmp", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.HLO_Sk.setObjectName("HLO_Sk")
        ...
        self.HLO_zr_zo_st_odZ.setObjectName("HLO_zr_zo_st_odZ")
        self.HLO_zr_zo_st_odZ.setGeometry(QRect(899, 322, 23, 43))
        icon7 = QIcon()
        icon7.addFile("img/Zriad/Zriad_basicL.bmp", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.HLO_L.setObjectName("HLO_L")
        self.HLO_L.setGeometry(QRect(838, 315, 38, 58))
        icon8 = QIcon()
        icon8.addFile("img/HlavneNav/Hl_basicP.bmp", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.HLO_trat_suhlas_doZ.setObjectName("HLO_trat_suhlas_doZ")
        self.HLO_trat_suhlas_doZ.setGeometry(QRect(804, 372, 39, 18))
        icon9 = QIcon()
        icon9.addFile("img/TS/TS_basicL.bmp", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.HLO_pracovisko.setObjectName("HLO_pracovisko")
        ...
        self.HLO_pracovisko.setPixmap(QPixmap("img/Stanice/Pracovisko.bmp"))
        ...
        self.HLO_1k_fik.setObjectName("HLO_1k_fik")
        ...
        self.HLO_2k_fik.setObjectName("HLO_2k_fik")
        ...
        self.HLO_k2_kon.setObjectName("HLO_k2_kon")
        self.HLO_k2_kon.setGeometry(QRect(1416, 372, 3, 60))
        self.HLO_k2_kon.setPixmap(QPixmap("img/Kolaj/Kol_koniec_volna.bmp"))
        self.HLO_k1_kon = QLabel(self.centralwidget)
        self.HLO_k1_kon.setObjectName("HLO_k1_kon")
        self.HLO_k1_kon.setGeometry(QRect(1416, 315, 3, 60))
        self.HLO_k1_kon.setPixmap(QPixmap("img/Kolaj/Kol_koniec_volna.bmp"))
        ...
        self.H_ZBE_HLO_priec.setObjectName("H_ZBE_HLO_priec")
    ...
    def retranslateUi(self, ILTIS):
        ...
        self.actionPriponiemka.setText(
        ...
        self.actionIdentifik_cei_u_vate_a.setText(
            QCoreApplication.translate(
        ...
        self.textHlohovec.setText(
            QCoreApplication.translate(
                "ILTIS",
                '<html><head/><body><p><span style=" font-size:18pt; font-weight:700; color:#d0d0d0;">Hlohovec</span></p></body></html>',
                None,
            )
        )
        ...
        self.groupCentrala.setTitle(
            QCoreApplication.translate("ILTIS", "Hlohovec", None)
        )
        ...
        self.label_6.setText(
            QCoreApplication.translate("ILTIS", "ILTIS-N Hlohovec", None)
        )
