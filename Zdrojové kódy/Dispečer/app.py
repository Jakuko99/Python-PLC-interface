    ...
    def __init__(self, app_instance):
        self.dictUseky = {  # slovník úsekov
            ...
            1: Usek(
                ID=0,
                nazovGUI="RAD_k1",
                enummIkon=ico.KolajSt1,
                dictIkon=ico.dictStanKolaj1,
                app=app_instance,
            ),
            2: Usek(
                ID=1,
                nazovGUI="RAD_k2",
                enummIkon=ico.KolajSt2,
                dictIkon=ico.dictStanKolaj2,
                app=app_instance,
            ),
            3: Vyhybka(
                ID=2,
            ...
            4: Usek(
                ...
                nazovGUI="RAD_Sk",
                enummIkon=ico.Kolaj,
                dictIkon=ico.dictKolaj,
                app=app_instance,
            ),
            5: Usek(
                ID=4,
                nazovGUI="RAD_ZBE_TU1",
                enummIkon=ico.Kolaj,
                dictIkon=ico.dictKolaj,
                app=app_instance,
            ),
            ...
            12: Vyhybka(
                ...
                usek="ZBE_v1",
                spojka=True,
                enumIkon=ico.SpojkaA,
                dictIkon=ico.dictSpojkaA,
                zavisla=40,
                app=app_instance,
            ),
            13: Vyhybka(
                ...
                usek="ZBE_v2",
                spojka=True,
                enumIkon=ico.SpojkaB,
                dictIkon=ico.dictSpojkaB,
                zavisla=41,
                app=app_instance,
            ),
            14: Usek(
            ...
            47: Usek(
                ID=6,
                nazovGUI="DISP_ZBE_HLO_TU1_2",
                enummIkon=ico.Kolaj45,
                dictIkon=ico.dictKolaj45,
                app=app_instance,
            ),
            48: Usek(
                ID=6,
                nazovGUI="DISP_ZBE_HLO_TU1_3",
                enummIkon=ico.Kolaj45,
                dictIkon=ico.dictKolaj45,
                app=app_instance,
            ),
        ...
        self.dictTS = {  # slovník traťových súhlasov
            1: TratSuhlas(
                ID=1,
                nazovGUI="RAD_trat_suhlas_doZ",
                enumIkon=ico.TrSP,
                dictIkon=ico.dictTrSP,
                app=app_instance,
                typ="L",
            ),
            2: TratSuhlas(
                ID=2,
                nazovGUI="ZBE_trat_suhlas_doR",
                enumIkon=ico.TrSL,
                dictIkon=ico.dictTrSL,
                app=app_instance,
                typ="S",
            ),
            3: TratSuhlas(
                ID=3,
                nazovGUI="ZBE_trat_suhlas_doH",
                enumIkon=ico.TrSP,
                dictIkon=ico.dictTrSP,
                app=app_instance,
                typ="L",
            ...
            6: TratSuhlas(
                ID=1,
                nazovGUI="DISP_RAD_trat_suhlas_doZ",
                enumIkon=ico.TrSP,
                dictIkon=ico.dictTrSP,
                app=app_instance,
                typ="L",
            ...
            7: TratSuhlas(
                ID=2,
                nazovGUI="DISP_ZBE_trat_suhlas_doR",
                enumIkon=ico.TrSL,
                dictIkon=ico.dictTrSL,
                app=app_instance,
                typ="S",
            ...
            8: TratSuhlas(
                ID=3,
                nazovGUI="DISP_ZBE_trat_suhlas_doH",
                enumIkon=ico.TrSP,
                dictIkon=ico.dictTrSP,
                app=app_instance,
                typ="L",
            ...
            9: TratSuhlas(
                ID=4,
                nazovGUI="DISP_ZBE_trat_suhlas_doL",
                enumIkon=ico.TrSL,
                dictIkon=ico.dictTrSL,
                app=app_instance,
                typ="L",
            ...
            10: TratSuhlas(
                ID=5,
                nazovGUI="DISP_HLO_trat_suhlas_doZ",
                enumIkon=ico.TrSL,
                dictIkon=ico.dictTrSL,
                app=app_instance,
                typ="S",
        ...
        self.dictPriecestie = {  # slovník priecestí
            1: Priecestie(
                ID=1,
                nazovGUI="RAD_ZBE_priec",
                enumIkon=ico.Priecestie,
                dictIkon=ico.dictPriecestie,
                app=app_instance,
            ),
            2: Priecestie(
                ID=2,
                nazovGUI="H_ZBE_HLO_priec",
                enumIkon=ico.Priecestie,
                dictIkon=ico.dictPriecestie,
                app=app_instance,
            ),
        ...
        self.dictStanice = {  # slovník stníc
            1: RiadenieObsluhy(
                ID=1,
                nazovGUI="RAD_dialkove",
                enumIkon=ico.RiadenieRAD,
                dictIkon=ico.dictRiadenieRAD,
                app=app_instance,
            ),
            2: RiadenieObsluhy(
                ID=2,
                nazovGUI="ZBE_dialkove",
                enumIkon=ico.RiadenieZBE,
                dictIkon=ico.dictRiadenieZBE,
                app=app_instance,
            ),
            3: RiadenieObsluhy(
                ID=3,
                nazovGUI="HLO_dialkove",
                enumIkon=ico.RiadenieHLO,
                dictIkon=ico.dictRiadenieHLO,
                app=app_instance,
            ),
            4: RiadenieObsluhy(
                ID=4,
                nazovGUI="DISP_RAD_dialkove",
                enumIkon=ico.RiadenieRAD,
                dictIkon=ico.dictRiadenieRAD,
                app=app_instance,
            ),
            ...
            if data is not None:
                for index in self.dictUseky.keys():  # čítanie stavov koľajových úsekov
                    if index in list(range(1, 10)) + list(range(29, 38)):
                        self.dictUseky[index].jeVolny = data["RAD;RAD-ZBE"][
                            self.dictUseky[index].ID
                        ]

                    elif index in list(range(10, 18)) + list(range(38, 46)):
                        self.dictUseky[index].jeVolny = data["ZBE"][
                            self.dictUseky[index].ID
                        ]

                    elif index in list(range(18, 21)) + list(range(22, 25)) + list(
                        range(46, 52)
                    ):
                        self.dictUseky[index].jeVolny = data["P1;P2;ZBE-HLO"][
                            self.dictUseky[index].ID
                        ]

                    elif index in list(range(25, 29)) + list(range(53, 57)):
                        self.dictUseky[index].jeVolny = data["HLO"][
                            self.dictUseky[index].ID
                        ]
                        ...
                        21,
                        52,
                    ]:  # špeciálny prípad kedy sa dopytuje aj na LifeSigh ESA 44
                    ...
                    if index in [3, 31]:  # čítanie smeru výmen
                        self.dictUseky[index].smer = data["SmerVyh"][
                            self.dictUseky[index].IDsmer
                        ]
                ...
                for index in self.dictStanice.keys():  # čítanie stavov riadenia staníc
                    if index in [1, 4]:
                        self.dictStanice[index].dialkove = data["Riadenie"][
                            "dialkoveRAD"
                        ]
                ...
                self.predhlaskaZBE = data["TS"][
                    "odchodZH"
                ]  # čítanie predhlášok zo staníc
                self.predhlaskaHLO = data["TS"]["odchodH"]

                if data["Cesta"]["stavanie"]:
                    if (
                        data["Cesta"]["pociatocne"] in self.app_instance.dictNav.keys()
                        and data["Cesta"]["koncove"] in self.app_instance.dictNav.keys()
                    ) and (data["Cesta"]["odosielatel"] != "DISP"):
                        self.app_instance.Start = data["Cesta"]["pociatocne"]
                        self.app_instance.dictNav[
                            self.app_instance.Start
                        ].pociatocne = True
                        self.app_instance.End = data["Cesta"]["koncove"]
                        self.app_instance.szz.typCesty = data["Cesta"]["typCesty"]
                        ochr = data["Cesta"]["OD"]
                        self.app_instance.szz.stavanieCesty(
                            Disp=True, OD=ochr, server=True
                        )
                        self.app_instance.prikazDoPLC(cesta=True)

                if data["Cesta"]["rusenie"]:
                    if (
                        data["Cesta"]["koncove"] in self.app_instance.dictNav.keys()
                        and data["Cesta"]["odosielatel"] != "DISP"
                    ):
                        self.app_instance.End = data["Cesta"]["koncove"]
                ...
                if (
                    data["Navest"]["ID"] != 0
                    and data["Navest"]["ID"] in self.app_instance.dictNav.keys()
                    and data["Navest"]["odosielatel"] != "DISP"
                ):
                    self.app_instance.dictNav[data["Navest"]["ID"]].znak = data[
                        "Navest"
                    ]["znak"]
                    ...
                    if self.app_instance.dictNav[data["Navest"]["ID"]].zavisle != -1:
                        self.app_instance.dictNav[
                            self.app_instance.dictNav[data["Navest"]["ID"]].zavisle
                        ].znak = data["Navest"]["znak"]
                        self.app_instance.dictNav[
                            self.app_instance.dictNav[data["Navest"]["ID"]].zavisle
                        ].manual = True
                        self.app_instance.dictNav[
...
class App(QMainWindow):  # hlavná triedy vizualizácie
    def __init__(self, parent=None):
        ...
        self.dictNav = {  # slovník návestidiel
            ...
            1: Navestidlo(
                ...
                usekPred="RAD_Sk",
                usekZa="RAD_V1",
                nazovGUI="RAD_zr_do_st_odZ",
                enumIkon=ico.NavZriadL,
                dictIkon=ico.dictZriadovacieL,
                app=self,
            ),
            2: Navestidlo(
                ID=2,
                nazov="R_Se1p",
                usekPred="RAD_Sk",
                nazovGUI="RAD_zr_zo_st_odZ",
                enumIkon=ico.NavZriadP,
                dictIkon=ico.dictZriadovacieP,
                app=self,
            ),
            3: Navestidlo(
                ID=3,
                nazov="R_S",
                usekPred="RAD_ZBE_TU1",
                usekZa="RAD_Sk",
                nazovGUI="RAD_S",
                enumIkon=ico.NavVchodL,
                dictIkon=ico.dictVchodoveL,
                zavisle=46,
                app=self,
            ),
            4: Navestidlo(
                ...
                usekZa="RAD_V1",
                nazovGUI="RAD_L1",
                enumIkon=ico.NavOdchodP,
                dictIkon=ico.dictOdchodoveP,
                zavisle=47,
                app=self,
            ),
            5: Navestidlo(
            ...
            8: Navestidlo(
                ...
                nazov="R_19",
                usekPred="RAD_ZBE_TU1",
                usekZa="RAD_ZBE_TU2_1",
                nazovGUI="RAD_ZBE_19",
                enumIkon=ico.NavVchodP,
                dictIkon=ico.dictVchodoveP,
                app=self,
                oddielove=True,
                TZZ="AB3",
            ),
            ...
            10: Navestidlo(
                ...
                usekPred="RAD_k1",
                nazovGUI="RAD_k1_fik",
                enumIkon=ico.NavOdchodL,
                dictIkon=ico.dictOdchodoveL,
                zavisle=50,
                app=self,
            ),
            11: Navestidlo(
            ...
            31: Navestidlo(
                ID=31,
                nazov="Z_So",
                usekPred="ZBE_HLO_TU2_a",
                usekZa="ZBE_HLO_TU1_1",
                nazovGUI="ZBE_HLO_So",
                enumIkon=ico.NavVchodL,
                dictIkon=ico.dictVchodoveL,
                zavisle=70,
            ...
            44: Navestidlo(
                ID=44,
                nazov="H_Lo",
                usekPred="H_ZBE_HLO_TU1_1",
                usekZa="H_ZBE_HLO_TU2_a",
                nazovGUI="H_ZBE_HLO_Lo",
                enumIkon=ico.NavVchodP,
                dictIkon=ico.dictVchodoveP,
                zavisle=69,
                app=self,
            ...
            45: Navestidlo(
                ID=45,
                nazov="H_So",
                usekPred="H_ZBE_HLO_TU2_a",
                usekZa="H_ZBE_HLO_TU1_1",
                nazovGUI="H_ZBE_HLO_So",
                enumIkon=ico.NavVchodL,
                dictIkon=ico.dictVchodoveL,
                zavisle=70,
                app=self,
            ...
            47: Navestidlo(
                ID=47,
                nazov="DR_L1",
                usekPred="DISP_RAD_k1",
                usekZa="DISP_RAD_V1",
                nazovGUI="DISP_RAD_L1",
                enumIkon=ico.NavVchodP,
                dictIkon=ico.dictVchodoveP,
                zavisle=4,
                app=self,
            ...
            48: Navestidlo(
                ID=48,
                nazov="DR_L2",
                usekPred="DISP_RAD_k2",
                usekZa="DISP_RAD_V1",
                nazovGUI="DISP_RAD_L2",
                enumIkon=ico.NavVchodP,
                dictIkon=ico.dictVchodoveP,
                zavisle=5,
                app=self,
            ...
            49: Navestidlo(
                ID=49,
                nazov="DR_S_fik",
                usekPred="DISP_RAD_Sk",
                nazovGUI="DISP_RAD_fik_S",
                enumIkon=ico.FiktP,
                dictIkon=ico.dictFiktP,
                zavisle=6,
                app=self,
            ...
            52: Navestidlo(
                ...
                nazov="DR_19",
                usekPred="DISP_RAD_ZBE_TU1",
                usekZa="DISP_RAD_ZBE_TU2a",
                nazovGUI="DISP_RAD_ZBE_19",
                enumIkon=ico.NavVchodP,
                dictIkon=ico.dictVchodoveP,
                app=self,
                oddielove=True,
            ...
            53: Navestidlo(
                ID=53,
                nazov="DR_18",
                usekPred="DISP_RAD_ZBE_TU2a",
                usekZa="DISP_RAD_ZBE_TU1",
                nazovGUI="DISP_RAD_ZBE_18",
                enumIkon=ico.NavVchodL,
                dictIkon=ico.dictVchodoveL,
                app=self,
                oddielove=True,
            ...
            54: Navestidlo(
                ID=54,
                nazov="DR_29",
                usekPred="DISP_RAD_ZBE_TU2b",
                usekZa="DISP_RAD_ZBE_TU3",
                nazovGUI="DISP_RAD_ZBE_29",
                enumIkon=ico.NavVchodP,
                dictIkon=ico.dictVchodoveP,
                app=self,
                oddielove=True,
            ...
            55: Navestidlo(
                ID=55,
                nazov="DR_28",
                usekPred="DISP_RAD_ZBE_TU3",
                usekZa="DISP_RAD_ZBE_TU2b",
                nazovGUI="DISP_RAD_ZBE_28",
                enumIkon=ico.NavVchodL,
                dictIkon=ico.dictVchodoveL,
                app=self,
                oddielove=True,
            ...
            56: Navestidlo(
                ID=56,
                nazov="DZ_RAD_ZBE_40",
                usekPred="DISP_RAD_ZBE_TU4",
                usekZa="DISP_RAD_ZBE_TU3",
                nazovGUI="DISP_RAD_ZBE_40",
                enumIkon=ico.NavVchodL,
                dictIkon=ico.dictVchodoveL,
                app=self,
                oddielove=True,
            ...
            57: Navestidlo(
                ...
                nazov="DZ_RAD_ZBE_39",
                usekPred="DISP_RAD_ZBE_TU3",
                usekZa="DISP_RAD_ZBE_TU4",
                nazovGUI="DISP_RAD_ZBE_39",
                enumIkon=ico.NavVchodP,
                dictIkon=ico.dictVchodoveP,
                app=self,
                oddielove=True,
            ...
            59: Navestidlo(
                ID=59,
                nazov="DZ_BL",
                usekPred="DISP_LUZ_ZBE_TU1",
                usekZa="DISP_ZBE_BLk",
                nazovGUI="DISP_ZBE_BL",
                enumIkon=ico.NavVchodP,
                dictIkon=ico.dictVchodoveP,
                zavisle=13,
                app=self,
            ...
            60: Navestidlo(
                ID=60,
                nazov="DZ_L_fik",
                usekPred="DISP_ZBE_Lk",
                nazovGUI="DISP_ZBE_fik_L",
                enumIkon=ico.FiktL,
                dictIkon=ico.dictFiktL,
                zavisle=14,
                app=self,
            ...
            61: Navestidlo(
                ID=61,
                nazov="DZ_BL_fik",
                usekPred="DISP_ZBE_BLk",
                nazovGUI="DISP_ZBE_fik_BL",
                enumIkon=ico.FiktL,
                dictIkon=ico.dictFiktL,
                zavisle=15,
                app=self,
            ...
            62: Navestidlo(
                ID=62,
                nazov="DZ_S1",
                usekPred="DISP_ZBE_k1",
                usekZa="DISP_ZBE_V1",
                nazovGUI="DISP_ZBE_S1",
                enumIkon=ico.NavVchodL,
                dictIkon=ico.dictVchodoveL,
                zavisle=20,
                app=self,
            ...
            63: Navestidlo(
                ID=63,
                nazov="DZ_S2",
                usekPred="DISP_ZBE_k2",
                usekZa="DISP_ZBE_V2",
                nazovGUI="DISP_ZBE_S2",
                enumIkon=ico.NavVchodL,
                dictIkon=ico.dictVchodoveL,
                zavisle=21,
                app=self,
            ...
            66: Navestidlo(
                ID=66,
                nazov="DZ_S_fik",
                usekPred="DISP_ZBE_Sk",
                nazovGUI="DISP_ZBE_fik_S",
                enumIkon=ico.FiktP,
                dictIkon=ico.dictFiktP,
                zavisle=26,
                app=self,
            ...
            69: Navestidlo(
                ID=69,
                nazov="DH_Lo",
                usekPred="DISP_ZBE_HLO_TU1_4",
                usekZa="DISP_ZBE_HLO_TU2_a",
                nazovGUI="DISP_ZBE_HLO_Lo",
                enumIkon=ico.NavVchodP,
                dictIkon=ico.dictVchodoveP,
                zavisle=30,
                app=self,
            ...
            70: Navestidlo(
                ID=70,
                nazov="DH_So",
                usekPred="DISP_ZBE_HLO_TU2_a",
                usekZa="DISP_ZBE_HLO_TU1_4",
                nazovGUI="DISP_ZBE_HLO_So",
                enumIkon=ico.NavVchodL,
                dictIkon=ico.dictVchodoveL,
                zavisle=45,
                app=self,
            ...
            72: Navestidlo(
                ID=72,
                nazov="DH_S1",
                usekPred="DISP_HLO_k1",
                usekZa="DISP_HLO_V1",
                nazovGUI="DISP_HLO_S1",
                enumIkon=ico.NavVchodL,
                dictIkon=ico.dictVchodoveL,
                zavisle=38,
                app=self,
            ...
            73: Navestidlo(
                ID=73,
                nazov="DH_S2",
                usekPred="DISP_HLO_k2",
                usekZa="DISP_HLO_V1",
                nazovGUI="DISP_HLO_S2",
                enumIkon=ico.NavVchodL,
                dictIkon=ico.dictVchodoveL,
                zavisle=39,
                app=self,
            ...
            74: Navestidlo(
                ID=74,
                nazov="DH_L_fik",
                usekPred="DISP_HLO_Sk",
                nazovGUI="DISP_HLO_fik_L",
                enumIkon=ico.FiktL,
                dictIkon=ico.dictFiktL,
                zavisle=40,
                app=self,
        ...
        self.workerThread = dataUpdate(
            self
        )  # prepojenie bočných vláken s hlavným vláknom
        ...
        self.workerThread.dataUpdated.connect(
            self.update
        )  # definícia prepojenia vláken a metód
        self.workerThread.dataUpdated.connect(
            lambda: self.szz.stavanieCesty(True, Disp=True)
        )
    ...
    def update(
        self, ID=-1, clicked=False, objekt="update"
    ):  # metóda pre aktualizáciu symbolov objektov
        ...
        if objekt in ["update", "navestidla"]:  # aktualizácia návestidiel
            self.dictNav[8].zhasnute = self.workerThread.dictTS[
                1
            ].smer  # otáčanie svietenia AB podľa TS
            ...
            for ID in self.dictNav.keys():  # vyberaj z návestidiel
                for i in self.workerThread.dictUseky.keys():  # vyberaj z úsekov
                    if (
                        self.dictNav[ID].usekPred
                        == self.workerThread.dictUseky[i].nazovGUI
                    ):  # ak sa nájde úsek previazaný s návestidlom
                        self.dictNav[ID].jeVolnyPred = self.workerThread.dictUseky[
                            i
                        ].jeVolny  # aktualizuj symbol návestidla podľa obsadenia úseku

                    if (
                        self.dictNav[ID].usekPred
                        == self.workerThread.dictUseky[i].nazovGUI
                    ):  # ak sa nájde úsek previazaný s návestidlom
                        self.dictNav[ID].usekOdozva = self.workerThread.dictUseky[
                            i
                        ].odozva  # aktualizuj symbol návestidla podľa LIfeSign úseku

                    if (
                        self.dictNav[ID].usekZa
                        == self.workerThread.dictUseky[i].nazovGUI
                    ):  # ak sa nájde úsek previazaný s návestidlom
                        self.dictNav[ID].jeVolnyZa = self.workerThread.dictUseky[
                            i
                        ].jeVolny  # aktualizuj symbol návestidla podľa obsadenia úseku
        ...
        if objekt in ["update", "priecestie"]:  # aktualizácia priecestí
            if clicked and ID in self.workerThread.dictPriecestie:
                self.workerThread.dictPriecestie[ID].vyber = (
                    not self.workerThread.dictPriecestie[ID].vyber
                )
        ...
        if objekt in ["update", "Stanice"]:  # aktualizácia raidenia stanice
            if clicked and ID in self.workerThread.dictStanice:
                self.workerThread.dictStanice[ID].vyber = (
                    not self.workerThread.dictStanice[ID].vyber
                )
    ...
    def clickObjekt(self, id, objekt):  # metóda spracovávajúca kliknutie na objekt
        if objekt == "navestidlo":
            ...
            if (
                (
                    id in [3, 46, 47, 48, 50, 51]
                    and self.workerThread.dictStanice[1].dialkove
                )
                or (  # ak má precovisko aktívne riadenie
                    id in [12, 13, 27, 58, 59, 62, 63, 64, 65, 67]
                    and self.workerThread.dictStanice[2].dialkove
                )
                or (
                    id in [37, 71, 72, 73, 76, 77]
                    and self.workerThread.dictStanice[3].dialkove
                )
            ):  # vchodové návestidlo
                self.update(
                    id, True, objekt="navestidla"
                )  # aktualizuj symbol návestidla
                ...
                (id in [4, 5, 10, 11] and self.workerThread.dictStanice[1].dialkove)
                or (  # ak má precovisko aktívne riadenie
                    id in [20, 21, 22, 23] and self.workerThread.dictStanice[2].dialkove
                )
                or (
                    id in [38, 39, 42, 43] and self.workerThread.dictStanice[3].dialkove
                )
                ...
                (id in [1, 2] and self.workerThread.dictStanice[1].dialkove)
                or (  # ak má precovisko aktívne riadenie
                    id in [16, 17, 18, 19, 24, 25]
                    and self.workerThread.dictStanice[2].dialkove
                )
                or (id in [35, 36] and self.workerThread.dictStanice[3].dialkove)
                ...
                (id in [6, 49] and self.workerThread.dictStanice[1].dialkove)
                or (  # ak má precovisko aktívne riadenie
                    id in [14, 15, 26, 60, 61, 66]
                    and self.workerThread.dictStanice[2].dialkove
                )
                or (id in [40, 74] and self.workerThread.dictStanice[3].dialkove)
            ):  # fiktívne návestidlo
                self.update(
                    id, True, objekt="navestidla"
                )  # aktualizuj symbol návestidla
                ...
                id in [31, 69] and self.workerThread.dictStanice[2].dialkove
            ) or (  # ak má precovisko aktívne riadenie
                id in [44, 70] and self.workerThread.dictStanice[3].dialkove
            ...
            if id in self.workerThread.dictUseky:  # ak sa výhybka nachádza v zozname
                ...
                if (
                    (id in [3, 31] and self.workerThread.dictStanice[1].dialkove)
                    or (
                        id in [12, 13, 16, 40, 41, 44]
                        and self.workerThread.dictStanice[2].dialkove
                    )
                    or (id in [26, 54] and self.workerThread.dictStanice[3].dialkove)
                ):  # ak má precovisko aktívne riadenie
                    if id in [12, 13]:  # úprava pre výhybkovú spojku
                        self.workerThread.dictUseky[12].vyber = (
                            not self.workerThread.dictUseky[12].vyber
                        )
                        self.workerThread.dictUseky[13].vyber = (
                            not self.workerThread.dictUseky[13].vyber
                        )
                        ...
                        self.workerThread.dictUseky[40].vyber = (
                            not self.workerThread.dictUseky[40].vyber
                        )
                        self.workerThread.dictUseky[41].vyber = (
                            not self.workerThread.dictUseky[41].vyber
                        )
                        self.workerThread.dictUseky[40].update(self)
                        self.workerThread.dictUseky[41].update(self)

                    else:
                        self.workerThread.dictUseky[id].vyber = (
                            not self.workerThread.dictUseky[id].vyber
                        )
                        self.workerThread.dictUseky[id].update(self)

                    if self.workerThread.dictUseky[
                        id
                    ].vyber:  # je výhybka vybraná obsluhou?
                        self.comboShowHide(
                            "vyhybka"
                        )  # ak áno zobraz kontextové okno akcií
                    else:
                        self.comboShowHide()  # ak nie skry kontextové okno

                else:
                    self.vypisHlasenia(
                        "Obsluha stanice prevedená na lokálne pracovisko"
                    )

        elif objekt == "priecestie":
            self.lastPri = id
            if (id in [1, 3] and self.workerThread.dictStanice[1].dialkove) or (
                id in [2, 4, 5] and self.workerThread.dictStanice[3].dialkove
            ):  # ak má precovisko aktívne riadenie
            ...
            self.lastTS = id
            if (
                (id in [1, 6] and self.workerThread.dictStanice[1].dialkove)
                or (
                    id in [2, 3, 4, 7, 8, 9]
                    and self.workerThread.dictStanice[2].dialkove
                )
                or (id in [5, 10] and self.workerThread.dictStanice[3].dialkove)
            ):  # ak má precovisko aktívne riadenie
                if (id in [4, 9]) or (
                    id in [1, 2, 6, 7]
                    and (
                        not self.workerThread.dictStanice[1].dialkove
                        or not self.workerThread.dictStanice[2].dialkove
                    )
                ):
                    self.workerThread.dictTS[id].vybrane = not self.workerThread.dictTS[
                        id
                    ].vybrane
                    if self.workerThread.dictTS[id].vybrane:
                        ...
                        self.comboShowHide()
                elif (id in [3, 5, 8, 10]) or (
                    id in [1, 2, 6, 7]
                    and (
                        self.workerThread.dictStanice[1].dialkove
                        or self.workerThread.dictStanice[2].dialkove
                    )
                ):
                    self.workerThread.dictTS[id].vybrane = not self.workerThread.dictTS[
                        id
    ...
    def comboShowHide(
        self, nazov=" "
    ):  # metóda pre zobrazovanie výberových ponúk pre návestidlá
        if nazov == "vchodove":  # zobrazí menu pre vchodové návestidlo
            ...
            nazov == "odchodove_konc"
        ):  # zobrazí menu pre výber typu cesty pre odchodové návestidlo
            ...
            nazov == "zriadovacie_konc"
        ):  # zobrazí menu pre výber typu cesty pre zriaďovacie návestidlo
            ...
            nazov == "fiktivne_konc"
        ):  # zobrazí menu pre výber typu cesty pre fiktívne návestidlo
    ...
    def akciaPriecestie(self, index):  # vyhodnotenie vybranej akcie z kontextového menu
        ...
        if index == 1:  # zatvorenie priecetia
            self.prikazDoPLC(
                priec=True,
                nazov=self.workerThread.dictPriecestie[self.lastPri].nazovGUI,
                prikaz="/True",
            )
        ...
        self.ui.combo_priec.setCurrentIndex(
            0
        )  # resetuj index vybranej akcie z kontextového menu

    def akciaNavestidlo(
        self, index, ID
    ):  # vyhodnotenie vybranej akcie z kontextového menu
        self.comboShowHide()  # po výbere skry menu

        if ((ID in [1, 2]) and index == 1) and (
            self.lastNav not in [10, 11, 42, 43, 50, 51, 76, 77]
        ):  # výber vlakovej cesty
            self.vyberCestu("Vlak")

        elif (ID == 2 and index == 2) or (
            ID == 3 and index == 1
        ):  # výber posunovej cesty
            ...
            self.Start in [3, 12, 13, 27, 37, 46, 58, 59, 67, 68, 71]
            and ID in [10, 12, 13]
            and index == 1
        ):  # stavanie vchodovej bez ochrannej dráhy
            ...
            (ID in [10, 12, 13]) and (index == 2) and (not self.szz.typCesty)
        ):  # stavanie vchodovej cesty s ochrannou dráhou
            ...
            self.Start in [4, 5, 20, 21, 22, 23, 38, 39, 47, 48, 62, 63, 64, 65, 72, 73]
        ) and (
            (ID in [10, 12]) and (index == 1) and (not self.szz.typCesty)
        ):  # stavanie odchodovej cesty
        ...
        elif (ID == 10 and index == 3) or (
            ID == 11 and index == 1
        ):  # stavanie posunovej cesty
            self.postavCestu()
            ...
            if self.dictNav[self.lastNav].znak == "Stoj":
                ...
                self.prikazDoPLC(
                    prikaz="/PN",
                    id=self.dictNav[self.lastNav].ID,
                    nazov=self.dictNav[self.lastNav].nazov,
                )
            ...
            self.lastNav not in [10, 11, 42, 43, 50, 51, 76, 77]
        ):  # Manuálne zadanie 'Stoj'
            self.dictNav[self.lastNav].vybrane = False

            if (self.dictNav[self.lastNav].pociatocne) or (
                self.dictNav[self.lastNav].TZZ == "AH"
                and self.dictNav[self.lastNav].predhlaska
            ):  # iba ak je návestidlo počiatočným návestidlom jazdnej cesty
            ...
            if (self.dictNav[self.lastNav].pociatocne) or (
                ...
                self.dictNav[self.lastNav].manual = True
                if (ID in [1, 5]) or (
                    ID == 2 and not self.dictNav[self.lastNav].typAktCes
                ):
        ...
        self.ui.combo_hlavne.setCurrentIndex(
            0
        )  # resetuj index vybranej akcie z kontextového menu
    ...
    def akciaTS(self, index, id):  # metóda pre prácu s traťovým súhlasom
        ...
        elif ((index == 1 and id == 1) or (index == 3 and id == 2)) and (
            self.workerThread.dictTS[self.lastTS].prijem is True
        ):  # udelenie TS
    ...
    def akciaStanica(self, index):  # metóda pre spracovanie signálov riadenia
        if index == 1:  # žiadosť o prevzatie riadenia
            if not self.workerThread.dictStanice[self.lastStanica].dialkove:
                if self.workerThread.dictStanice[
                    self.lastStanica
                ].ziadost:  # ak už je aktívna žiadosť
                    self.prikazDoPLC(
                        prikaz="/True",
                        nazov=self.workerThread.dictStanice[self.lastStanica].nazovGUI,
                        ziadRiad=False,
                    )  # zruš ju
                ...
                self.vypisHlasenia(
                    "Obsluha stanice prevedená na pracovisko vzdialenej obsluhy"
                )
    ...
    def vyberCestu(
        self, typ
    ):  # metóda pre zápis potrebných hodnôt pre výber jazdnej cesty
        ...
        self.dictNav[self.Start].typAktCes = (
            self.szz.typCesty
        )  # zapíše počiatočnému návestidlu typ cesty
        self.dictNav[self.Start].vybrane = False
        self.dictNav[self.Start].update(self)

    def postavCestu(
        self, Ochr=False
    ):  # metóda, ktorá vydá príkaz pre postavenie vybranej cesty algoritmom SZZ
    ...
    def ukonciStavanie(
        self, TS=False, odhl=False, volnost=False
    ):  # metóda slúži na ukončenie stavania VC v prípade zlého TS alebo obsadeného medzist. úseku
    ...
    def prikazDoPLC(
        ...
        cas=False,
        znak=False,
    ):  # metóda pre odosielanie dát do PLC
                ...
                if nazov == "stavanie":
                    if prikaz == "True":
                        URL = (
                            ...
                            + str(end)
                            + "/"
                            + str(self.szz.typCesty)
                            + "/True/True/False/DISP"
                        )
    ...
    def vypisHlasenia(
        self, hlasenie
    ):  # metóda pre výpis varovného hlásenia pri zlej obsluhe
...
if __name__ == "__main__":
    ...
    widget.ui.RadosinaLupa.setVisible(
        False
    )  # po spustení skryje podrobné zobrazenia staníc
    ...
    widget.ui.combo_hlavne.currentIndexChanged.connect(
        lambda: widget.akciaNavestidlo(widget.ui.combo_hlavne.currentIndex(), 1)
    )  # počiatok jazdnej cesty
    widget.ui.combo_kombi.currentIndexChanged.connect(
        lambda: widget.akciaNavestidlo(widget.ui.combo_kombi.currentIndex(), 2)
    )
    widget.ui.combo_zriad.currentIndexChanged.connect(
        lambda: widget.akciaNavestidlo(widget.ui.combo_zriad.currentIndex(), 3)
    )
    widget.ui.combo_fikt.currentIndexChanged.connect(
        lambda: widget.akciaNavestidlo(widget.ui.combo_fikt.currentIndex(), 4)
    )
    widget.ui.combo_oddielove.currentIndexChanged.connect(
        lambda: widget.akciaNavestidlo(widget.ui.combo_oddielove.currentIndex(), 5)
    )

    widget.ui.combo_ciel_ko.currentIndexChanged.connect(
        lambda: widget.akciaNavestidlo(widget.ui.combo_ciel_ko.currentIndex(), 10)
    )  # koniec jazdnej cesty
    widget.ui.combo_ciel_zr.currentIndexChanged.connect(
        lambda: widget.akciaNavestidlo(widget.ui.combo_ciel_zr.currentIndex(), 11)
    )
    widget.ui.combo_ciel_fi.currentIndexChanged.connect(
        lambda: widget.akciaNavestidlo(widget.ui.combo_ciel_fi.currentIndex(), 12)
    )
    widget.ui.combo_ciel_hl.currentIndexChanged.connect(
        lambda: widget.akciaNavestidlo(widget.ui.combo_ciel_hl.currentIndex(), 13)
    )

    widget.ui.combo_priec.currentIndexChanged.connect(
        lambda: widget.akciaPriecestie(widget.ui.combo_priec.currentIndex())
    )  # priecestie

    widget.ui.combo_Riadenie.currentIndexChanged.connect(
        lambda: widget.akciaStanica(widget.ui.combo_Riadenie.currentIndex())
    )  # riadenie stanice

    widget.ui.combo_TS_DISP.currentIndexChanged.connect(
        lambda: widget.akciaTS(widget.ui.combo_TS_DISP.currentIndex(), 1)
    )  # traťový súhlas
    widget.ui.combo_TS_ESA.currentIndexChanged.connect(
        lambda: widget.akciaTS(widget.ui.combo_TS_ESA.currentIndex(), 2)
    )

    widget.ui.combo_vyh.currentIndexChanged.connect(
        lambda: widget.szz.prestavenieVyh(
            widget.lastVyh, widget.ui.combo_vyh.currentIndex()
        )
    )  # prestavenie výmeny

    widget.ui.actionLupa_Radosina.triggered.connect(
        lambda: widget.lupa(1)
    )  # práca s podrobnými obrazmi staníc
    ...
    widget.ui.actionVlastnosti.triggered.connect(
        lambda: widget.popUp(okno="REST")
    )  # práca s oknom REST API
    ...
    # ---------------NÁVESTIDLÁ-------------------------------------------
    widget.ui.RAD_zr_do_st_odZ.clicked.connect(
        lambda: widget.clickObjekt(1, "navestidlo")
    )
    widget.ui.RAD_zr_zo_st_odZ.clicked.connect(
        lambda: widget.clickObjekt(2, "navestidlo")
    )
    ...
    widget.ui.ZBE_zr_zo_st_odR.clicked.connect(
        lambda: widget.clickObjekt(16, "navestidlo")
    )
    widget.ui.ZBE_zr_zo_st_odL.clicked.connect(
        lambda: widget.clickObjekt(17, "navestidlo")
    )
    widget.ui.ZBE_zr_do_st_odR.clicked.connect(
        lambda: widget.clickObjekt(18, "navestidlo")
    )
    widget.ui.ZBE_zr_do_st_odL.clicked.connect(
        lambda: widget.clickObjekt(19, "navestidlo")
    )
    ...
    widget.ui.ZBE_zr_do_st_odH.clicked.connect(
        lambda: widget.clickObjekt(24, "navestidlo")
    )
    widget.ui.ZBE_zr_zo_st_odH.clicked.connect(
        lambda: widget.clickObjekt(25, "navestidlo")
    )
    ...
    # --------------------------------------------------------------------
    widget.ui.HLO_zr_do_st_odZ.clicked.connect(
        lambda: widget.clickObjekt(35, "navestidlo")
    )
    widget.ui.HLO_zr_zo_st_odZ.clicked.connect(
        lambda: widget.clickObjekt(36, "navestidlo")
    )
    ...
    widget.ui.DISP_RAD_fik_S.clicked.connect(
        lambda: widget.clickObjekt(49, "navestidlo")
    )
    widget.ui.DISP_RAD_k1_fik.clicked.connect(
        lambda: widget.clickObjekt(50, "navestidlo")
    )
    widget.ui.DISP_RAD_k2_fik.clicked.connect(
        lambda: widget.clickObjekt(51, "navestidlo")
    )
    # --------------------------------------------------------------------
    ...
    widget.ui.DISP_ZBE_fik_L.clicked.connect(
        lambda: widget.clickObjekt(60, "navestidlo")
    )
    widget.ui.DISP_ZBE_fik_BL.clicked.connect(
        lambda: widget.clickObjekt(61, "navestidlo")
    )
    ...
    widget.ui.DISP_ZBE_fik_S.clicked.connect(
        lambda: widget.clickObjekt(66, "navestidlo")
    )
    widget.ui.DISP_ZBE_S.clicked.connect(lambda: widget.clickObjekt(67, "navestidlo"))
    # --------------------------------------------------------------------
    widget.ui.DISP_ZBE_HLO_Lo.clicked.connect(
        lambda: widget.clickObjekt(69, "navestidlo")
    )
    widget.ui.DISP_ZBE_HLO_So.clicked.connect(
        lambda: widget.clickObjekt(70, "navestidlo")
    )
    ...
    widget.ui.DISP_HLO_fik_L.clicked.connect(
        lambda: widget.clickObjekt(74, "navestidlo")
    )
    widget.ui.DISP_HLO_k1_fik.clicked.connect(
        lambda: widget.clickObjekt(76, "navestidlo")
    )
    widget.ui.DISP_HLO_k2_fik.clicked.connect(
        lambda: widget.clickObjekt(77, "navestidlo")
    )
    # --------------------------------------------------------------------
    # -------------VÝHYBKY------------------------------------------------
    ...
    # ----------------------------DISPEČER--------------------------------
    widget.ui.DISP_RAD_trat_suhlas_doZ.clicked.connect(
        lambda: widget.clickObjekt(6, "TS")
    )
    widget.ui.DISP_ZBE_trat_suhlas_doR.clicked.connect(
        lambda: widget.clickObjekt(7, "TS")
    )
    widget.ui.DISP_ZBE_trat_suhlas_doH.clicked.connect(
        lambda: widget.clickObjekt(8, "TS")
    )
    widget.ui.DISP_ZBE_trat_suhlas_doL.clicked.connect(
        lambda: widget.clickObjekt(9, "TS")
    )
    widget.ui.DISP_HLO_trat_suhlas_doZ.clicked.connect(
        lambda: widget.clickObjekt(10, "TS")
    )
    # --------------------------------------------------------------------
    # -------------PRIECESTIE---------------------------------------------
    widget.ui.RAD_ZBE_priec.clicked.connect(lambda: widget.clickObjekt(1, "priecestie"))
    widget.ui.H_ZBE_HLO_priec.clicked.connect(
        lambda: widget.clickObjekt(2, "priecestie")
    )
    widget.ui.DISP_RAD_ZBE_priec.clicked.connect(
        lambda: widget.clickObjekt(3, "priecestie")
    )
    widget.ui.DISP_ZBE_HLO_priec.clicked.connect(
        lambda: widget.clickObjekt(4, "priecestie")
    )
    # --------------------------------------------------------------------
    # -------------RIADENIE STANICE---------------------------------------
    ...
    widget.ui.DISP_RAD_dialkove.clicked.connect(
        lambda: widget.clickObjekt(4, "stanica")
    )
    widget.ui.DISP_ZBE_dialkove.clicked.connect(
        lambda: widget.clickObjekt(5, "stanica")
    )
    widget.ui.DISP_HLO_dialkove.clicked.connect(
        lambda: widget.clickObjekt(6, "stanica")
    )

    widget.ui.ButtonConnect.clicked.connect(
        widget.zahajPripojenie
    )  # prepojenie s metódou pre testovanie spojenia s PLC
    widget.ui.ButtonDisconnect.clicked.connect(
        widget.ukonciPripojenie
    )  # vyvolá ukončenie komunikácie
